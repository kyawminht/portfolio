  ...
  return (
    <div className='mt-5 scroll-smooth' id='contact'>
      <div className="grid justify-center m-10">
        <span className="text-red-500 dark:text-white">I am ready to be hired</span>
        <h4 className="text-3xl font-bold font dark:text-white mt-10 font-serif">Hire Me</h4>
      </div>
      <section className="bg-indigo-300 dark:bg-gray-900 rounded-lg shadow-lg mx-auto container sm:w-1/2 w-full mb-10">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <div class="sm:col-span-2">
              <label htmlFor="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Message</label>
            ...
            <button type="submit" className=" bg-green-500 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
          </form>
        </div>
      </section>
    </div>
