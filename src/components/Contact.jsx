      ...
      <section className="bg-indigo-300 dark:bg-gray-900 rounded-lg shadow-lg mx-auto container sm:w-1/2 w-full mb-10">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <div class="sm:col-span-2">
            ...
            <button type="submit" className="bg-rose-400 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
          </form>
        </div>
      </section>
    </div>
